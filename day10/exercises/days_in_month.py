...
print("This program calculates the number of days of a chosen month.")
year = int(input("Enter a year: ")) # Enter a year
month = int(input("Enter the number of a month: ")) # Enter a month
days = days_in_month(year, month)
print(f"The month number {month} of the year {year} has a total of {days} days.")
